...
description: Convenciones de nombres para capas, componentes y estilos que facilitan el handoff
---

# Guía de Nomenclatura

Convenciones de nombres para capas, componentes y estilos que facilitan el handoff. Adopta estas convenciones desde el inicio del proyecto para mantener consistencia.

## Principios Generales

### 1. Consistencia
Usa el mismo patrón en todo el archivo. Si eliges `kebab-case`, úsalo siempre.
